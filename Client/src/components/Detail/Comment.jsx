        ...
        <div className="contenedor">
            <div className="contenedor-1">
                <section className="contenedor-sec">
                    ...
                    <div>
                        <input type="text" id="nuevoComentarios" className="input-com" placeholder="Enter your comment please ...." />
                        <div class="btn-comment">
                            <button className="btn" /*onClick={nComentarios()}*/>Comment</button>
                        </div>
                    </div>
                </section>
            </div>
            <ul id="comentarios" className="contenedor-2">
            </ul>
        </div>
    )
}
